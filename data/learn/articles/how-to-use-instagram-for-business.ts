...
const BLOCKS: ArticleContentBlock[] = [
  {
    ...
    type: 'paragraph',
    order: 1,
    text: "Instagram has evolved from a photo-sharing platform into one of the world's most influential marketing channels. Millions of businesses use it every day to showcase products, build trust, educate customers and strengthen relationships with their audience.",
  },
  {
    id: 'b-intro-2',
    type: 'paragraph',
    order: 2,
    text: "Whether you run a local business, an online store or a growing brand, Instagram offers an opportunity to connect with potential customers in a visual and engaging way. Success, however, isn't achieved simply by creating an account. It comes from building a professional presence, publishing valuable content and maintaining consistent communication with your audience.",
  },
  {
    id: 'b-intro-3',
    type: 'paragraph',
    order: 3,
    text: 'This guide explains how businesses can use Instagram effectively, even if they are just getting started.',
  },
  {
    id: 'b-related-pillar',
  ...
  },
  {
    ...
    type: 'heading',
    headingLevel: 2,
    text: 'Why Instagram Matters for Businesses',
    anchorId: 'why-instagram-matters-for-businesses',
    order: 5,
  },
  {
    id: 'b-why-1',
  ...
  },
  {
    ...
    type: 'heading',
    headingLevel: 2,
    text: 'Set Up a Professional Business Profile',
    anchorId: 'set-up-a-professional-business-profile',
    order: 11,
  },
  {
    id: 'b-profile-1',
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'Instagram business profile setup illustration showing logo, bio, contact information, website link and story highlights.',
      width: 1600,
      height: 900,
    },
  },
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'Instagram business content strategy dashboard showing product posts, educational content, publishing schedule and content planning.',
      width: 1600,
      height: 900,
    },
  },
  ...
  },
  {
    ...
    anchorId: 'monitor-business-performance',
    order: 41,
  },
  {
    id: 'b-insights-1',
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'Instagram business analytics dashboard displaying audience growth, engagement, profile visits, website clicks and performance metrics.',
      width: 1600,
      height: 900,
    },
  },
...
export const HOW_TO_USE_INSTAGRAM_FOR_BUSINESS_ARTICLE: LearnArticleRecord = {
  ...
  featuredImage: {
    ...
    alt: 'Illustration showing a business using Instagram with profile optimization, content planning, customer engagement and analytics dashboard.',
    width: 1920,
    height: 1080,
    priority: true,
  },
  ...
  seoReviewed: true,
  keyTakeaways: [
    'Treat Instagram as an extension of your business—not only an ads channel.',
    'Optimise your profile, define your audience and balance promo with educational content.',
    'Consistent branding, conversations and Insights reviews build long-term trust.',
  ],
  faqs: [
    {
      id: 'faq-every-business-instagram',
      question: 'Should every business have an Instagram account?',
      answer:
        'Not every business needs one, but for many industries Instagram provides an effective way to showcase products, share expertise and connect with potential customers.',
      schemaEligible: true,
    },
    {
      id: 'faq-what-businesses-post',
      question: 'What should businesses post on Instagram?',
      answer:
        'A healthy mix of educational content, product highlights, customer stories, behind-the-scenes updates and helpful tips usually performs better than constant promotional posts.',
      schemaEligible: true,
    },
    {
      ...
      answer:
        'Choose a schedule that your team can maintain consistently while keeping content quality high.',
      schemaEligible: true,
    },
    {
      id: 'faq-small-businesses-compete',
      question: 'Can small businesses compete on Instagram?',
      answer:
        'Yes. Smaller businesses often build loyal communities by creating authentic, helpful content and responding actively to their audience.',
      schemaEligible: true,
    },
  ],
  serviceCta: {
