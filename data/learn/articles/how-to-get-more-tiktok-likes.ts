...
const BLOCKS: ArticleContentBlock[] = [
  {
    ...
    type: 'paragraph',
    order: 1,
    text: 'Likes are one of the clearest signs that viewers appreciate your content. While they are only one part of TikTok engagement, consistently receiving more likes often indicates that your videos are connecting with the right audience.',
  },
  {
    id: 'b-intro-2',
    type: 'paragraph',
  ...
  },
  {
    ...
    type: 'paragraph',
    order: 3,
    text: 'Rather than searching for shortcuts, successful creators improve the quality of every upload. This guide explains practical strategies that naturally encourage viewers to like your videos while strengthening your overall TikTok content strategy.',
  },
  {
    id: 'b-related-pillar',
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'Illustration showing effective TikTok video hooks with audience attention, watch time improvement and engagement optimization.',
      width: 1600,
      height: 900,
    },
  },
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'Illustration showing high-engagement TikTok content including tutorials, educational videos, storytelling and audience interaction.',
      width: 1600,
      height: 900,
    },
  },
...
export const HOW_TO_GET_MORE_TIKTOK_LIKES_ARTICLE: LearnArticleRecord = {
  ...
  featuredImage: {
    ...
    alt: 'Illustration showing strategies to increase TikTok likes through engaging videos, audience interaction, content optimization and performance analytics.',
    width: 1920,
    height: 1080,
    priority: true,
  },
  ...
  seoReviewed: true,
  keyTakeaways: [
    'More TikTok likes usually come from videos viewers genuinely enjoy, understand and remember.',
    'Build videos that educate, entertain or inspire rather than chasing one engagement metric.',
    'As content quality improves, likes often rise alongside comments, shares and follower growth.',
  ],
  faqs: [
    {
      id: 'faq-likes-matter',
