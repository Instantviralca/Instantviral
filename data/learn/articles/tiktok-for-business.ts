...
const BLOCKS: ArticleContentBlock[] = [
  {
    ...
    type: 'paragraph',
    order: 1,
    text: "TikTok has evolved from a platform known primarily for entertainment into one of the world's most influential marketing channels. Millions of people now use TikTok every day to discover new products, learn practical skills, compare services and connect with brands. For businesses, this creates an opportunity to reach potential customers long before they are ready to make a purchase.",
  },
  {
    id: 'b-intro-2',
    type: 'paragraph',
    order: 2,
    text: 'Unlike many traditional social platforms, TikTok gives businesses of all sizes the opportunity to earn visibility through valuable content rather than relying only on an existing audience. A local company, startup or established brand can all compete for attention if they consistently publish videos that educate, entertain or solve real problems.',
  },
  {
    id: 'b-intro-3',
    type: 'paragraph',
  ...
  },
  {
    ...
    type: 'heading',
    headingLevel: 2,
    text: 'Why Businesses Should Use TikTok',
    anchorId: 'why-businesses-should-use-tiktok',
    order: 5,
  },
  {
    id: 'b-why-1',
  ...
  },
  {
    ...
    type: 'heading',
    headingLevel: 2,
    text: 'Define Clear Business Goals',
    anchorId: 'define-clear-business-goals',
    order: 11,
  },
  {
    id: 'b-goals-1',
  ...
  },
  {
    ...
    type: 'heading',
    headingLevel: 2,
    text: 'Optimise Your Business Profile',
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'TikTok business profile optimization illustration showing professional branding, profile setup, bio optimization and website integration.',
      width: 1600,
      height: 900,
    },
  },
  {
    ...
    type: 'heading',
    headingLevel: 2,
    text: 'Create Content That Educates First',
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'Illustration showing a TikTok business content strategy with educational videos, product demonstrations, publishing calendar and customer engagement.',
      width: 1600,
      height: 900,
    },
  },
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'TikTok business analytics dashboard displaying audience growth, engagement, website clicks, conversions and content performance.',
      width: 1600,
      height: 900,
    },
  },
...
export const TIKTOK_FOR_BUSINESS_ARTICLE: LearnArticleRecord = {
  ...
  featuredImage: {
    ...
    alt: 'Illustration showing a business using TikTok for marketing with content planning, audience engagement, analytics, brand awareness and business growth.',
    width: 1920,
    height: 1080,
    priority: true,
  },
  ...
  faqs: [
    {
      ...
      question: 'Is TikTok good for small businesses?',
      answer:
        'Yes. TikTok allows businesses of all sizes to reach new audiences through valuable and engaging content.',
      schemaEligible: true,
    },
    {
      id: 'faq-need-equipment',
      question: 'Do businesses need professional equipment?',
      answer:
        'No. Clear audio, good lighting and useful content are generally more important than expensive production equipment.',
      schemaEligible: true,
    },
    {
      id: 'faq-what-to-post',
      question: 'What should businesses post on TikTok?',
      answer:
        'Educational videos, tutorials, customer questions, product demonstrations, behind-the-scenes content and industry insights are all effective options.',
      schemaEligible: true,
    },
    {
      ...
      answer:
        'Choose a schedule that you can maintain consistently while keeping quality high.',
      schemaEligible: true,
    },
    {
      id: 'faq-generate-customers',
      question: 'Can TikTok help generate customers?',
      answer:
        'TikTok can increase brand awareness and build trust, both of which can contribute to future enquiries and sales.',
      schemaEligible: true,
    },
  ],
  serviceCta: {
