...
const BLOCKS: ArticleContentBlock[] = [
  {
    ...
    type: 'paragraph',
    order: 1,
    text: 'TikTok has created opportunities for creators, businesses and brands to reach large audiences without already having thousands of followers. Unlike many social media platforms, TikTok can introduce your content to new viewers based on how well each video performs rather than how popular your account already is.',
  },
  {
    id: 'b-intro-2',
    type: 'paragraph',
  ...
  },
  {
    ...
    type: 'paragraph',
    order: 3,
    text: "Growing your follower count isn't about finding one secret trick. It comes from understanding your audience, producing valuable videos consistently and learning from your performance over time. This guide explains practical strategies that can help you attract more followers while building an engaged community that continues to return to your content.",
  },
  {
    id: 'b-related-pillar',
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'TikTok profile optimization illustration showing profile photo, bio, username, branding and account setup for better follower growth.',
      width: 1600,
      height: 900,
    },
  },
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'TikTok content strategy illustration showing video planning, publishing schedule, content ideas and audience engagement workflow.',
      width: 1600,
      height: 900,
    },
  },
...
export const HOW_TO_GET_MORE_TIKTOK_FOLLOWERS_ARTICLE: LearnArticleRecord = {
  ...
  featuredImage: {
    ...
    alt: 'Illustration showing strategies to grow TikTok followers through engaging videos, profile optimization, audience interaction and analytics.',
    width: 1920,
    height: 1080,
    priority: true,
  },
  ...
  seoReviewed: true,
  keyTakeaways: [
    'Growing TikTok followers requires consistency, creativity and patience—not one secret trick.',
    'Build an account that provides ongoing value to a specific audience rather than chasing every trend.',
    'Small regular improvements usually outperform dramatic strategy changes for long-term growth.',
  ],
  faqs: [
    {
      ...
      answer:
        'Choose a schedule you can maintain consistently. Many creators publish several times each week while focusing on quality.',
      schemaEligible: true,
    },
    {
    ...
    {
      id: 'faq-how-long-grow',
      question: 'How long does it take to grow on TikTok?',
      answer:
        'Growth varies for every account, but consistency and continuous improvement generally produce the strongest long-term results.',
      schemaEligible: true,
    },
  ],
  serviceCta: {
