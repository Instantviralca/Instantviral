...
export const ANALYTICS_EVENT_REGISTRY: readonly EventRegistryEntry[] = [
  ...
  entry(
    ...
    'checkout_start',
    'analytics',
    'Legacy service checkout_start name (canonical: checkout_started)',
    { requiresServiceSlug: true },
  ),
  ...
  // First-party commerce funnel extensions (unique names only)
  entry('service_view', 'service', 'view', 'analytics', 'Service interest view'),
  entry('package_view', 'package', 'view', 'analytics', 'Package view', {
    requiresPackageId: true,
  }),
  entry('cta_click', 'engagement', 'click', 'analytics', 'CTA click'),
  entry('checkout_started', 'checkout', 'start', 'analytics', 'Checkout started'),
  entry('checkout_email_entered', 'checkout', 'email', 'analytics', 'Checkout email entered'),
  entry(
  ...
  entry('place_order_clicked', 'checkout', 'place_order', 'analytics', 'Place order clicked'),
  entry('payment_started', 'checkout', 'start', 'analytics', 'Payment redirect/start'),
  entry('payment_failed', 'checkout', 'fail', 'analytics', 'Payment failed or cancelled'),
  entry('payment_completed', 'checkout', 'complete', 'essential', 'Payment confirmed server-side', {
    channel: 'admin',
  }),
  entry('order_completed', 'purchase', 'complete', 'essential', 'Order completed server-side', {
    channel: 'admin',
  }),
  entry('cart_tracking_started', 'cart', 'track_start', 'essential', 'Abandoned cart tracking started', {
    channel: 'admin',
  }),
  entry('cart_abandoned', 'cart', 'abandoned', 'essential', 'Cart marked abandoned', {
    channel: 'admin',
  }),
  entry('recovery_email_sent', 'cart', 'recovery_sent', 'essential', 'Recovery email sent', {
    channel: 'admin',
  }),
  entry('recovery_email_clicked', 'cart', 'recovery_click', 'essential', 'Recovery email clicked', {
    channel: 'admin',
  }),
  entry(
    ...
    'recovery_open',
    'essential',
    'Recovery checkout opened',
    { channel: 'admin' },
  ),
  entry('cart_recovered', 'cart', 'recovered', 'essential', 'Cart recovered after paid order', {
    channel: 'admin',
  }),
  entry('cart_lost', 'cart', 'lost', 'essential', 'Abandoned cart marked lost', {
    channel: 'admin',
  }),
  entry('track_order_click', 'engagement', 'track_order', 'analytics', 'Track order click'),
...
export const LEGACY_EVENT_ALIASES: Readonly<Record<string, string>> = {
  // Service-page "checkout_start" aliases share the commerce funnel event.
  // Cart / order configuration is not checkout — emit only when checkout begins.
  service_checkout_start: 'checkout_started',
  ...
  ig_followers_checkout_start: 'checkout_started',
  ...
  ig_likes_checkout_start: 'checkout_started',
  ...
  ig_views_checkout_start: 'checkout_started',
  ...
  ig_comments_checkout_start: 'checkout_started',
  ...
  tiktok_followers_checkout_start: 'checkout_started',
  ...
  tiktok_likes_checkout_start: 'checkout_started',
  ...
  tiktok_views_checkout_start: 'checkout_started',
  ...
  facebook_followers_checkout_start: 'checkout_started',
  ...
  facebook_page_likes_checkout_start: 'checkout_started',
  ...
  facebook_post_likes_checkout_start: 'checkout_started',
  ...
  youtube_subscribers_checkout_start: 'checkout_started',
  ...
  youtube_views_checkout_start: 'checkout_started',
