...
const FLOW = [
  ...
  'Package Confirmed',
  'Checkout Complete',
  'Followers Delivering',
  'Order Completed',
] as const;

/**
 * Facebook Followers horizontal progress flow for How To Buy.
 */
export function FacebookFollowersProcessTimeline({ className }: { className?: string }) {
  const fbBlue = '#1877F2';
