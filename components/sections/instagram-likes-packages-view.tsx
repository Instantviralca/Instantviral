...
import { PackageOptionTiers } from '@/components/marketing/packages/package-option-tiers';
...
/**
 * Premium ecommerce likes packages page.
...
export function InstagramLikesPackagesView({ service }: InstagramLikesPackagesViewProps) {
  ...
  return (
    <div className="pb-24 lg:pb-0">
      ...
      {config.optionTiers ? (
        <PackageOptionTiers
          title={config.optionTiers.title}
          description={config.optionTiers.description}
          cards={config.optionTiers.cards}
        />
      ) : null}
